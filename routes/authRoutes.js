...
const { register, login, logout, verify, getOtp, changePassword } = require("../controllers/authController");
...
router.post("/change-password", changePassword); // Route to request OTP
